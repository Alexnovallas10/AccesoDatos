...
public class EJ_01_2_Jugadores_main {
	...
	public static void main(String[] args) {
		...
		File f = new File("AD_04_BDOO\\Neodatis\\Data\\equipos.db");
		f.delete();

		//Creo la conexión
		ODB odb = ODBFactory.open("AD_04_BDOO\\Neodatis\\Data\\equipos.db");
		...
		EJ_01_3_Paises BorrarPais=(EJ_01_3_Paises) odb.getObjects(query2).getFirst();

		// Y lo borramos
		odb.delete(BorrarPais);
		odb.close();
