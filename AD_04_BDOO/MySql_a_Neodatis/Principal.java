...
public class Principal {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/profes?serverTimezone=UTC", "root", "root");
			bd = ODBFactory.open("AD_04_BDOO\\MySql_a_Neodatis\\Data\\profesasig.neo");
