...
public class principal {
	...
	public static void main(String[] args)throws IOException, JAXBException {
		...
		insertarventa(35, "Cliente 2", 12, "25-11-2019");//inserta otra venta en el documento xml
		// visualizarxml();
	}
	...
	public static void visualizarxml() throws IOException, JAXBException {
		...
		System.out.println("------------------------------ ");
			...
			JAXBElement jaxbElement = (JAXBElement) u.unmarshal(new FileInputStream("src\\P07_Mapearxml_clase\\ventasarticulos.xml"));
	...
	private static void insertarventa(int numeventa, String nomcli, int uni, String fecha) {
		...
		try {
			...
			if (existe == 0) {
				...
				Marshaller m = jaxbContext.createMarshaller();
				m.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
				m.marshal(jaxbElement, new FileOutputStream("src\\P07_Mapearxml_clase\\ventasarticulos.xml"));
